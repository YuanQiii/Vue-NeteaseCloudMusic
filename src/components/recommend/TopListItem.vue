 ...
 * @LastEditTime: 2022-02-16 13:51:58
    ...
    <div class="head">
      ...
      <div class="op">
        ...
        <div class="icon">
          ...
          <div class="collect" @click="collect(toplistDetail['id'])"></div>
        </div>
      </div>
    </div>
    <div class="content">
...
<script>
import { playPlaylist, collectPlaylist } from "@/utils/operate.js";
